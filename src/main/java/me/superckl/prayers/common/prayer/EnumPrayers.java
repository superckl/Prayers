...
public enum EnumPrayers {
	...
	PROTECT_ITEM("protItem", EnumChatFormatting.YELLOW+"Protect Item", Arrays.asList("Keeps the item in your hand through death."), 0.2F, false, false, Collections.EMPTY_LIST, new ResourceLocation(ModData.MOD_ID+":textures/prayer/protectitem.png")),
