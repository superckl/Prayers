...
public enum EnumPrayers {
	...
	ENHANCE_MAGIC_2("eMagic2", EnumChatFormatting.YELLOW+"Mystic Will", Arrays.asList("Increases magic strength by 10%"), 0.25F, false, false, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENCHANCE_DEFENCE_3("eDefence3", EnumChatFormatting.YELLOW+"Resilient", Arrays.asList("Increases defence by 15%"), 0.3F, false, true, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENHANCE_MELEE_3("eMelee3", EnumChatFormatting.YELLOW+"Power", Arrays.asList("Increases melee strength by 15%"), 0.35F, false, true, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENHANCE_RANGE_3("eRange3", EnumChatFormatting.YELLOW+"Keen Eye", Arrays.asList("Increases ranged strength by 15%"), 0.35F, false, true, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENHANCE_MAGIC_3("eMagic3", EnumChatFormatting.YELLOW+"Mystic Might", Arrays.asList("Increases magic strength by 15%"), 0.35F, false, true, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENCHANCE_DEFENCE_4("eDefence4", EnumChatFormatting.YELLOW+"Robust", Arrays.asList("Increases defence by 25%"), 0.5F, false, true, ImmutableList.of(ENCHANCE_DEFENCE_3), new ResourceLocation("textures/items/fire.png")),
	ENHANCE_MELEE_4("eMelee4", EnumChatFormatting.YELLOW+"Vigor", Arrays.asList("Increases melee strength by 25%"), 0.6F, false, true, ImmutableList.of(ENHANCE_MELEE_3), new ResourceLocation("textures/items/fire.png")),
	ENHANCE_RANGE_4("eRange4", EnumChatFormatting.YELLOW+"Hawk Eye", Arrays.asList("Increases ranged strength by 25%"), 0.6F, false, true, ImmutableList.of(ENHANCE_RANGE_3), new ResourceLocation("textures/items/fire.png")),
	ENHANCE_MAGIC_4("eMagic4", EnumChatFormatting.YELLOW+"Mystic Attunement", Arrays.asList("Increases magic strength by 25%"), 0.6F, true, true, ImmutableList.of(ENHANCE_MAGIC_3), new ResourceLocation("textures/items/fire.png")),
	...
	POTENCY_1("eAll1", EnumChatFormatting.AQUA+"Effective", Arrays.asList("Increases damage output by 30%"), 5F, false, true, ImmutableList.of(ENHANCE_MAGIC_4, ENHANCE_RANGE_4, ENHANCE_MELEE_4), new ResourceLocation("textures/items/fire.png")),
	POTENCY_2("eAll2", EnumChatFormatting.AQUA+"Potent", Arrays.asList("Increases damage output by 50%"), 7F, false, true, ImmutableList.of(POTENCY_1), new ResourceLocation("textures/items/fire.png"));//TODO
