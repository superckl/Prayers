...
public enum EnumPrayers {
	...
	ENCHANCE_DEFENCE_2("eDefence2", EnumChatFormatting.YELLOW+"Durable", Arrays.asList("Increases defence by 15%"), 0.2F, false, false, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENHANCE_MELEE_2("eMelee2", EnumChatFormatting.YELLOW+"Strength", Arrays.asList("Increases melee strength by 15%"), 0.25F, false, false, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENHANCE_RANGE_2("eRange2", EnumChatFormatting.YELLOW+"Sharp Eye", Arrays.asList("Increases ranged strength by 15%"), 0.25F, false, false, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENHANCE_MAGIC_2("eMagic2", EnumChatFormatting.YELLOW+"Mystic Will", Arrays.asList("Increases magic strength by 15%"), 0.25F, false, false, Collections.EMPTY_LIST, new ResourceLocation("textures/items/fire.png")),
	ENCHANCE_DEFENCE_3("eDefence3", EnumChatFormatting.YELLOW+"Robust", Arrays.asList("Increases defence by 25%"), 0.5F, false, true, ImmutableList.of(ENCHANCE_DEFENCE_2), new ResourceLocation("textures/items/fire.png")),
	ENHANCE_MELEE_3("eMelee3", EnumChatFormatting.YELLOW+"Vigor", Arrays.asList("Increases melee strength by 25%"), 0.6F, false, true, ImmutableList.of(ENHANCE_MELEE_2), new ResourceLocation("textures/items/fire.png")),
	ENHANCE_RANGE_3("eRange3", EnumChatFormatting.YELLOW+"Hawk Eye", Arrays.asList("Increases ranged strength by 25%"), 0.6F, false, true, ImmutableList.of(ENHANCE_RANGE_2), new ResourceLocation("textures/items/fire.png")),
	ENHANCE_MAGIC_3("eMagic3", EnumChatFormatting.YELLOW+"Mystic Attunement", Arrays.asList("Increases magic strength by 25%"), 0.6F, true, true, ImmutableList.of(ENHANCE_MAGIC_2), new ResourceLocation("textures/items/fire.png")),
