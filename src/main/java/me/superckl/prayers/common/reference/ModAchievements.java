...
public final class ModAchievements {
	...
	public static final Achievement ANCIENTS_WRATH = new Achievement("prayerachwrath", "prayerwrath", 2, 2, ModItems.basicBone, ModAchievements.FIRST_STEPS).registerStat();
	public static final Achievement GODS_WRATH = new Achievement("prayerachgodwrath", "prayergodwrath", 2, 4, ModItems.bottle, ModAchievements.ANCIENTS_WRATH).setSpecial().registerStat();
	...
	public static final AchievementPage PRAYERS_PAGE = new AchievementPage(ModData.MOD_NAME, ModAchievements.RECHARGED, ModAchievements.TOO_OP, ModAchievements.FIRST_STEPS, ModAchievements.ANCIENTS_WRATH, ModAchievements.GODS_WRATH);
