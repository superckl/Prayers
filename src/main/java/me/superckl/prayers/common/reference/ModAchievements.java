...
public final class ModAchievements {
	...
	public static final Achievement GODS_WRATH = new Achievement("prayerachgodwrath", "prayergodwrath", 2, 4, ModItems.bottle, ModAchievements.ANCIENTS_WRATH).registerStat();
